# importing the modulus from tkinter
from tkinter import Tk, Radiobutton, Button, Label, StringVar, IntVar, Entry

# creating class and main application container
...
class TipCalculator():
    def __init__(self):
        ...
        five_percent_tip = Radiobutton(
            window, text="0.5%", variable=self.tip_percent, value=5)
        ...
        thirty_percent_tip = Radiobutton(
            window, text="30%", variable=self.tip_percent, value=30)
        ...
        bill_total_lb1 = Label(window, text="Bill Total",
                               bg='blue', fg='white')
